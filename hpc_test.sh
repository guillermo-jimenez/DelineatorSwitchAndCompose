...
do
  ...
  python3 test_holter.py --basedir ~/DADES/DADES/Delineator/ --model_name ${model} --hpc 0 --database ludb;
  python3 test_holter.py --basedir ~/DADES/DADES/Delineator/ --model_name ${model} --hpc 0 --database zhejiang;
done
